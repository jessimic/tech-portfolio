...
const siteConfig = {
    ...
    tagline: 'Dedicated to adapting ethical machine learning tools to further academic pursuits, learning, and research to empower everyone in STEAM (Science, Technology, Engineering, Arts, and Mathematics).',
    ...
    headerLinks: [
        ...
        { doc: "projects", label: "Research" },
        { doc: "pubpres", label: "Publications & Presentations" },
        { doc: "poas", label: "Portrait of a Scientist" },
        { doc: "buddysyst", label: "Buddy System Program" },
        { doc: "outreach", label: "Outreach & Teaching" },
    ...
    socialMedia: {
        ...
        twitter: 'https://twitter.com/jessielmic',
        github: 'https://github.com/jessimic',
        youtube: 'https://www.youtube.com/@portraitofascientist3539',
    },
};
